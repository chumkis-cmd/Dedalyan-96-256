...
Полная реализация блочного шифра Dedalyan-96/256 по спецификации версии 1.0
([`dedalyan-spec.md`](dedalyan-spec.md)), тестовый набор по разделу 10 и
криптоаналитический набор по разделу 0.
...
| `cli.py` | Командная строка: файлы в режиме CTR, подключи, трассировка |
